...
class ViewHolderTelaDescricao(view: View): RecyclerView.ViewHolder(view) {
    ...
    widget.ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {
        override fun onMove(
            ...
            val adapterTelaDescricao = AdapterTelaDescricao()
            val from = viewHolder.adapterPosition
            val to = target.adapterPosition
            adapterTelaDescricao.notifyItemMoved(from, to)
    ...
    fun MovimentacaoSimples(recyclerView : RecyclerView) {
